...
public class DetalhesLembrete extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DetalhesLembrete dialog = new DetalhesLembrete(null);
	 ...
	 * Create the dialog.
	 */
	public DetalhesLembrete(LembreteVO lVO) {
		...
		getContentPane().setLayout(new BorderLayout());
		{
			...
			}
			{
				...
				lblDetalhesDoLembrete.setIcon(new ImageIcon(DetalhesLembrete.class.getResource("/imagens/icons8-ver-detalhes-25.png")));
			...
			}
			{
				...
				btnVoltar.setIcon(new ImageIcon(DetalhesLembrete.class.getResource("/imagens/icons8-voltar-25.png")));
