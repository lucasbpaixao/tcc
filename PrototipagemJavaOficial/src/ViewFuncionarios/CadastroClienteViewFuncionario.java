...
public class CadastroClienteViewFuncionario extends JInternalFrame {
	...
	private void initialize() {
		...
		btnCadastroDeFornecedores.setBackground(new Color(0, 0, 0));
		...
		btnCadastroDeProdutos.setBackground(new Color(0, 0, 0));

		JButton btnEstoque = new JButton("Estoque");
		btnEstoque .setMnemonic(KeyEvent.VK_4);
		...
		btnEstoque.setBackground(new Color(0, 0, 0));

		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(0, 490, 270, 2);

		JLabel lblAdministrador = new JLabel("Funcionario");
	...
	//	}
		...
		frmCadastroDeCliente.getContentPane().add(lblUf);
				...
				btnAtualizar.setBounds(796, 716, 111, 37);
				...
				btnAtualizar.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
						...
						btnPreencherCampos.setBounds(471, 716, 165, 37);
	...
	private void cadastraCliente() throws Exception {
		...
		cController.cadastroDeClienteFuncionario(cVO);
	...
	private void limpar() {
		...
		CadastroClienteViewFuncionario.lblCnpj.setForeground(Color.BLACK);
		CadastroClienteViewFuncionario.lblComplemento.setForeground(Color.BLACK);
		CadastroClienteViewFuncionario.lblCidade.setForeground(Color.BLACK);
		...
		CadastroClienteViewFuncionario.lblTelCelular.setForeground(Color.BLACK);
