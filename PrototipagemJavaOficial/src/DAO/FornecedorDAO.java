...
public class FornecedorDAO {
	...
	public FornecedorVO PesquisarPorCodigo(int codigo) throws SQLException {
		...
		if (resultSet1.next() && resultSet2.next() && resultSet3.next()) {
			...
			fornecedorVO.setTelefone(resultSet3.getString("Fixo_Contato"));
			fornecedorVO.setTelefoneCelular(resultSet3.getString("Cel_Contato"));
	...
	public List<FornecedorVO> pesquisarFornecedorTodos() throws Exception {
		...
		PreparedStatement preparedStatement1 = this.connection.prepareStatement(
				"SELECT Fornecedor.Codigo_Fornecedor, Fornecedor.Nome_Fornecedor,Fornecedor.CNPJ_Fornecedor,endereco.Cep_Endereco,contato.Cel_Contato, contato.Fixo_Contato FROM endereco inner join fornecedor on(Fornecedor.Codigo_Fornecedor = endereco.Codigo_Fornecedor) inner join contato on (fornecedor.Codigo_Fornecedor = contato.Codigo_Fornecedor);");
		...
		while (resultSet.next()) {
			...
			fornecedorVO.setTelefoneCelular(resultSet.getString("Cel_Contato"));
			fornecedorVO.setTelefone(resultSet.getString("Fixo_Contato"));
